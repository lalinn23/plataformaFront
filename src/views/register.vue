<template>
      ...
      <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <form v-on:submit.prevent="login">
            ...
            <input type="text" id="first_name" class="fadeIn third" name="first_name" placeholder="Nombre" v-model="first_name">
            <input type="text" id="last_name" class="fadeIn third" name="last_name" placeholder="Apellido" v-model="last_name">
            <input type="email" id="email" class="fadeIn third" name="email" placeholder="email" v-model="email">
            <input type="puesto" id="puesto" class="fadeIn third" name="puesto" placeholder="Puesto" v-model="puesto">
  ...
  input[type=text], input[type=email], input[type="puesto"] {
    background-color: #f6f6f6;
    border: none;
    color: #0d0d0d;
    padding: 15px 32px;
